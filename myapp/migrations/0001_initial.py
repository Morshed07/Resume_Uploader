    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('Dhaka', 'Dhaka'), ('Rajshahi', 'Rajshahi'), ('Chittagong', 'Chittagong'), ('Barishal', 'Barishal'), ('Khulna', 'Khulna'), ('Rangpur', 'Rangpur'), ('Sylhet', 'Sylhet')], max_length=100)),
